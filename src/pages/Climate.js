    ...
    <>
          ...
          <div className="contantheder container">
            ...
            >
              ...
              <p className="textcontanthed">
                يدعم برنامج البيئة , المناخ الإجراءات التي تمكّن الشباب من ترجمة
                برامج تغير المناخ إلى سياسات فعالة لها تأثير قابل للقياس على
                رفاه الشباب ، ,وبما يضمن تجنيب الأجيال المقبلة آثار تغير المناخ
                القاسية
              </p>
      ...
      <section className="competitions container bottom" data-aos="fade-up">
        ...
        <div className="leftsideCompetitions">
          ...
          <p>
            مسابقة سنوية تشجع إشراك الشباب في جهود العمل من أجل المناخ ، بدعم من
            خبراء في تكنولوجيا المناخ وريادة الأعمال، باستكشاف أدوات التفكير
            التصميمي المبتكرة لإيجاد حلول للتخفيف من آثار تغير المناخ وللتكيف
            المناخي في قطاعات ومجالات تقنية مقترحة. يساعد البرنامج المشاركين على
            تفعيل مهاراتهم الريادية، وفي النهاية إنشاء حلول وأفكار عمل تستجيب
      ...
      <section className="explorerSection container bottom" data-aos="fade-up">
        ...
        <div className="bodyexplorer">
          <div className="rightbodyexplorer">
            <p>
              يمكن لكل ملاحظة أن تساهم في علم التنوع البيولوجي، شاركنا ملاحظاتك
              ، التقط صور من بيئتك ، وانشرها عبر معرضك العلمي الشخصي لتساعدنا
              على التعرف على النباتات والحيوانات من حولك. تواصل مع مجتمع
              الشغوفين بالطبيعة والذين يمكنهم مساعدتك في معرفة المزيد! علاوة على
              ذلك، من خلال تسجيل ومشاركة ملاحظاتك ، ستنشئ بيانات ذات جودة بحثية
              للعلماء الذين يعملون لفهم الطبيعة وحمايتها بشكل أفضل. كل ما عليك
              فعله هو الملاحظة وارسال صورة مرفقة بمعلومات كنت قد اكتشفتها وترغب
              في مشاركتها مع مجتمع الشغوفين بالطبيعة .
            </p>
          </div>
      ...
      <section className="titletextspark top " data-aos="fade-down">
        ...
        <div className="alltitletextspark  container">
          <div className="righttextspark">
            <h1>
              كلام في <br /> <div className="linetext"></div>
              <span> البيئة والمناخ </span>
            </h1>
          </div>
          <div className="lefttextspark">
            <img src={tex} alt="" />
            <p>
              منصة حرة تدعم نشر موضوعات ومقالات حول البيئة والتغير المناخي،
              والقضايا ذات العلاقة، وتشجع على المشاركة وتبادل الآراء
            </p>
            <img src={tex2} alt="" />
          </div>
        </div>
